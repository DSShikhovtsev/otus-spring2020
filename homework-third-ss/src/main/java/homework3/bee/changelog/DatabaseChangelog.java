package homework3.bee.changelog;
...
import homework3.security.User;
...
public class DatabaseChangelog {
    ...
    @ChangeSet(order = "005", id = "addUsers", author = "temp")
    public void insertUsers(MongoTemplate template) {
        template.save(new User("user", "password"));
        template.save(new User("admin", "admin"));
    }
}
